...
blob_img = pygame.image.load('img/enemy.png')
platform_x_img = pygame.image.load('img/thranio_pipi_ligo_pio_megalo.png')
platform_y_img = pygame.image.load('img/thranio_pipi_ligo_pio_megalo.png')
lava_img = pygame.image.load('img/lava.png')
coin_img = pygame.image.load('img/ects.png')
exit_img = pygame.image.load('img/exit.png')
water_img = pygame.image.load('img/water02.png')
...
vine = pygame.image.load('img/vine.png')
stone = pygame.image.load('img/stone.png')
big_stone = pygame.image.load('img/big_stone.png')
health_box = pygame.image.load('img/coffee.png')
monster_box = pygame.image.load('img/monster.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 15:
					#tree
					img = pygame.transform.scale(tree, (tile_size, tile_size // 2))						
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size//2)))
				if world_data[row][col] == 16:
					#vine
					img = pygame.transform.scale(vine, (tile_size, tile_size // 2))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size // 2)))
				if world_data[row][col] == 17:
					#stone
					img = pygame.transform.scale(stone, (tile_size, tile_size // 2))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size // 2)))
				if world_data[row][col] == 18:
					#bigger stone
					img = pygame.transform.scale(big_stone, (tile_size, tile_size // 2))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size // 2)))	
				if world_data[row][col] == 19:
					#health box 
					img = pygame.transform.scale(health_box, (tile_size, tile_size // 2))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size // 2)))
				if world_data[row][col] == 20:
					#monster box 
					img = pygame.transform.scale(monster_box, (tile_size, tile_size // 2))
					screen.blit(img, (col * tile_size, row * tile_size + (tile_size // 2)))		
